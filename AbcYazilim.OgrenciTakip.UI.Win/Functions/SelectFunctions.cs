    ...
    public class SelectFunctions : IDisposable
    {
        ...
        private void SecimYap()
        {
            switch (_btnEdit.Name)
            {
                case "txtIl":
                    {
                        var entity = (Il)ShowListForms<IlListForm>.ShowDialogListForm(_karTuru, _btnEdit.Id);
                        if (entity != null)
                        {
                ...
                case "txtIlce":
                    {
                        var entity = (Ilce)ShowListForms<IlceListForm>.ShowDialogListForm(_karTuru, _btnEdit.Id,_prmEdit.Id, _prmEdit.Text);
                        if (entity != null)
                        {
                            _btnEdit.Id = entity.Id;
